          ...
          <div className="p-10 text-center">
            ...
            <div className="rounded-xl p-4 mb-6 text-left space-y-2"
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-white">Transfer Bank</span>
              </div>
            </div>
      ...
      <div className="max-w-md mx-auto space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="rounded-3xl overflow-hidden shadow-2xl"
          ...
          <div className="p-6">
            ...
            {/* Info */}
            <div className="rounded-xl p-3.5 flex gap-2.5 text-sm mb-5"
              ...
              <p style={{ color: 'oklch(0.75 0.06 265)' }}>
                Setelah Anda mentransfer ke VA di atas, sistem akan otomatis mendeteksi dan status invoice menjadi <strong className="text-white">Lunas</strong>.
              </p>
            </div>
            ...
            <Button
              ...
              className="w-full h-13 text-base font-bold rounded-xl text-white shadow-xl"
              style={{ background: 'linear-gradient(135deg, oklch(0.58 0.22 264), oklch(0.55 0.22 295))', boxShadow: '0 8px 30px oklch(0.58 0.22 264 / 0.35)', height: '52px' }}
            >
              {isProcessing ? (
                <><Loader2 className="mr-2 h-5 w-5 animate-spin" /> Mendeteksi Transfer...</>
              ) : (
                "✓ Simulasi Transfer Sukses"
              )}
            </Button>
            <p className="text-center text-xs mt-2" style={{ color: 'oklch(0.50 0.04 265)' }}>
              *Klik tombol ini untuk menembak Webhook ke Backend
            </p>
          </div>
        </div>
